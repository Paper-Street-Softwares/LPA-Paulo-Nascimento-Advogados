        ...
        <SectionWrapper>
          <div className="container relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-title3 tablet1:text-title4 desktop3:text-title5">
                • Cobrança indevida? <br /> • Fraude ou golpe bancário? <br /> •
                Carro apreendido? <br /> • Quebra de safra? <br /> •
                Superendividamento?{' '}
              </p>
