...
const content = {
  texts: {
    ...
    hero: {
      miniTag: 'Advogado de Direito Bancário',
      title: (
        <h1>
          Foi{' '}
      ...
      subtitle: (
        <p>
          Você pode ter direito à revisão ou reparação. Conte com suporte
          jurídico especializado para defender seus interesses.
        </p>
      ),
    ...
    features: {
      ...
      title: (
        <h1>
          Atuação
          <span className="destaque italic font-light"> especializada</span> em
          Direito Bancário
        </h1>
      ),
      subtitle:
        'Defesas estratégicas e soluções jurídicas contra práticas abusivas de instituições financeiras.',
      imgFeatures: imgFeatures,
      alt: 'imagem representativa da Seção Serviços',
      titleMessageFeature: 'Atuação firme ',
      subtitleMessageFeature: 'contra abusos bancários.',
      cards: {
        card1: {
          title: 'Cobrança de juros abusivos',
          subtitle:
            'Os contratos bancários (financiamento de veículos, imóveis ou concessão de crédito) contendo juros abusivos devem ser revistos para evitar prejuízos ao consumidor.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card2: {
          title: <p>Busca e apreensão de veículos com irregularidades</p>,
          subtitle:
            'Se o banco ou financeira agiu de forma abusiva na retomada do seu veículo, saiba que é extremamente necessário defender-se no processo, com possibilidade de revisar todo o contrato, buscar reparação judicial e a devolução dos valores pagos indevidamente.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card3: {
          title: 'Financiamentos imobiliários',
          subtitle:
            'Se o seu imóvel foi levado a leilão, saiba que você pode recorrer ao judiciário para discutir eventuais nulidades no procedimento adotado pelo banco.',
          description: (
            <div>
              A_Definir <br />
              <br />
        ...
        card4: {
          ...
          subtitle:
            'Valores cobrados indevidamente, seja por erro ou má-fé, devem ser restituídos e podem gerar direito à indenização por danos morais.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card5: {
          title: <p>Execuções e cobranças de dívidas</p>,
          subtitle:
            'Se você está sendo executado, ou cobrado judicialmente pelo banco, como devedor principal ou fiador, saiba que poderá defender-se no processo e revisar todo o contrato a fim de afastar encargos abusivos ou tarifas indevidas.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card6: {
          ...
          subtitle:
            'Se você foi vítima de fraude ou golpe, o banco é responsável pela segurança da sua conta, seus dados e cartões de crédito/débito. Você pode reaver os valores e receber compensação.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card7: {
          ...
          subtitle:
            'Pessoas físicas ou microempreendedores superendividados poderão renegociar suas dívidas para pagamento em até 60 meses, bem como reduzir os juros e encargos aplicados pelo banco. ',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card8: {
          ...
          subtitle: (
            <p>
              O alongamento de dívidas rurais é um direito do produtor, previsto
              na legislação brasileira (como a Lei 9.138/95 e o Manual de
              Crédito Rural - MCR 2.6.4), que permite prorrogar o prazo de
              pagamento de financiamentos rurais quando há perdas de safra por
              eventos climáticos ou dificuldades de comercialização, visando
              reorganizar o fluxo de caixa, diminuir parcelas e garantir a
              continuidade da produção. <br />
              <br />
              <strong>O que pode ser alongado:</strong> Dívidas de custeio,
              investimento, comercialização, e operações com recursos de fundos
              como FNO, FNE, FCO, FAT.
            </p>
          ),
          description: (
            <div>
        ...
        card9: {
          ...
          subtitle: (
            <p>
              Se a instituição financeira não prestou suporte ou negou a
              resolução de um problema claro, tal como a realização de um pix
              para chave errada, você pode exigir judicialmente seus direitos.
            </p>
          ),
          description: (
            <div>
        ...
        card10: {
          ...
          subtitle: (
            <p>
              As dívidas bancárias e os encargos abusivos podem ser renegociados
              não apenas judicialmente, mas também na esfera administrativa
              mediante redução significativa dos juros e correções. Fale com
              quem entende do assunto com profundidade!
            </p>
          ),
          description: (
            <div>
        ...
        card11: {
          title: 'Encerramento indevido de sua conta corrente',
          subtitle: (
            <p>
              Se a instituição financeira encerrou sua conta corrente de forma
              indevida, você poderá exigir reparação judicial.
            </p>
          ),
          description: (
            <div>
    ...
    about: {
      ...
      title: (
        <h1>
          Nossa atuação em
          <span className="destaque italic font-light"> Direito Bancário</span>
        </h1>
      ),
      subtitle: '',
      paragraph: (
        <div>
          Atuamos de forma especializada no Direito Bancário, com foco na defesa
          dos interesses de pessoas físicas e empresas diante de instituições
          financeiras. Nossa prática é orientada pela identificação de abusos
          contratuais, cobranças indevidas e condutas que desequilibram a
          relação entre banco e cliente.
          <br /> <br />
          Desenvolvemos uma atuação estratégica e personalizada, analisando cada
          caso de forma individual para construir soluções jurídicas eficazes,
          seguras e alinhadas à realidade financeira do cliente. A combinação
          entre domínio técnico da legislação bancária e uma abordagem clara e
          objetiva garante defesas consistentes em todas as instâncias.
          <br /> <br />
          Mantemos um rigoroso protocolo de atualização jurídica, acompanhando
          de perto o entendimento dos tribunais e as práticas do mercado
          financeiro. Ética, especialização e assertividade são os pilares que
          sustentam nossa atuação na proteção dos direitos bancários de nossos
          clientes.
        </div>
      ),
    ...
    ctaSecondary: {
      ...
      title: <h1>Abusos bancários não podem continuar.</h1>,
      subtitle:
        'Cobranças indevidas, contratos abusivos e práticas ilegais exigem atuação jurídica imediata. Entre em contato para uma análise estratégica do seu caso e retome o controle da sua vida financeira.',
      subtitleDireita: (
